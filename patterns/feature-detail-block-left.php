<?php
/**
 * Title: Feature Detail - background image with overlay text on right
 * Slug: bloxbywp/feature-detail-block-left
 * Categories: section
 * Description: A featured deatail section with description in a background image block on right and highlight and heading block on left. 
 *
 * @package WordPress
...
<!-- wp:group {"className":"feature-details-block-left common-padding pb-0","layout":{"type":"constrained"}} -->
<div class="wp-block-group feature-details-block-left common-padding pb-0">
