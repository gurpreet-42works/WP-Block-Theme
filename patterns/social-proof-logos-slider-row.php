...
/**
 * Title: A Social Proof - Logos Grid Row 
 * Slug: bloxbywp/social-proof-logos-slider-flex
 * Categories: section
 * Description: A Social Proof with logos in a slider layout in a flex layout.
 *
 * @package WordPress
...
<!-- wp:group {"className":"social-proof-logos-slider common-padding"} -->
        ...
        <div class="wp-block-columns are-vertically-aligned-center">
            ...
            <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:20%">
                ...
                <div class="wp-block-group section-heading-wrap text-center">
                    <!-- wp:heading {"textAlign":"left","className":"mb-3"} -->
                    <h2 class="wp-block-heading has-text-align-left mb-3">Title Goes Here</h2>
                    <!-- /wp:heading -->
                </div>
                <!-- /wp:group -->
            </div>
