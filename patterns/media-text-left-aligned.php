...
<div class="wp-block-group alignfull content-with-media-section common-padding ">
    ...
    <div class="wp-block-group container">
        ...
        <div class="wp-block-group alignwide row align-items-center">
            <!-- wp:media-text {"mediaPosition":"left","mediaType":"image","className":"col-md-12 media-rounded-lg media-shadow pb-md-5 pb-0 pt-5"} -->
            <div class="wp-block-media-text has-media-on-the-left is-stacked-on-mobile alignwide col-md-12 media-rounded-lg media-shadow pb-md-5 pb-0 pt-5">
